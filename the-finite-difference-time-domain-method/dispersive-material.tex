...
\end{equation}
\begin{equation}
  E^{n+1} = \left(\frac{2\epsilon_0\epsilon_{\infty} - \Delta t \beta_p}{2\epsilon_0\epsilon_{\infty} + \Delta t \beta_p}\right)E^n + \left(\frac{2\Delta t}{2\epsilon_0\epsilon_{\infty} + \Delta t \beta_p}\right)\left(\nabla\times H^{n+1/2} - \frac{1}{2}(1+k_p)J_p^n\right)
\end{equation}
