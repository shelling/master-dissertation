...
By defining the $\chi$-related term as the phasor polorization displacement $J_p(\omega)$.
...
\end{equation}
Both semi-implicit and leapfrog scheme can be chose.
semi-implicit has accuracy the same as RC.
leapfrog has better accuracy.
