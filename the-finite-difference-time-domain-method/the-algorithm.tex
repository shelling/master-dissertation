...
\begin{gather}
  \begin{array}{@{}l@{}}
    ...
    \displaystyle \frac{\widetilde{B}_y|_{i+\frac{1}{2},j,k+\frac{1}{2}}^{n+\frac{1}{2}} - \widetilde{B}_y|_{i+\frac{1}{2},j,k+\frac{1}{2}}^{n-\frac{1}{2}}}{\Delta t} = \\
    \displaystyle c_0\left(\frac{\widetilde{E}_x|_{i+\frac{1}{2},j,k+1}^{n} - \widetilde{E}_x|_{i+\frac{1}{2},j,k}^{n}}{\Delta z} - \frac{\widetilde{E}_z|_{i+1,j,k+\frac{1}{2}}^n - \widetilde{E}_z|_{i,j,k+\frac{1}{2}}^n}{\Delta x}\right)\\[3em]
    \displaystyle \frac{\widetilde{B}_z|_{i+\frac{1}{2},j+\frac{1}{2},k}^{n+\frac{1}{2}} - \widetilde{B}_z|_{i+\frac{1}{2},j+\frac{1}{2},k}^{n-\frac{1}{2}}}{\Delta t} = \\
    \displaystyle c_0\left(\frac{\widetilde{E}_y|_{i+1,j+\frac{1}{2},k}^{n} - \widetilde{E}_y|_{i,j+\frac{1}{2},k}^{n}}{\Delta x} - \frac{\widetilde{E}_x|_{i+\frac{1}{2},j+1,k}^n - \widetilde{E}_x|_{i+\frac{1}{2},j,k}^n}{\Delta y}\right)
  \end{array}
\end{gather}
