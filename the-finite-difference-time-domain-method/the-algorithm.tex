...
\begin{gather}
  \begin{array}{@{}l@{}}
    ...
    \displaystyle c_0\left(\frac{H_x|_{i,j+\frac{1}{2},k+\frac{1}{2}}^{n} - H_x|_{i,j+\frac{1}{2},k-\frac{1}{2}}^{n}}{\Delta z} - \frac{H_y|_{i+\frac{1}{2},j+\frac{1}{2},k}^{n} - H_y|_{i-\frac{1}{2},j+\frac{1}{2},k}^{n}}{\Delta x}\right)\\
