...
Now the most essential update equations were obtained. The next thing is to implement it in real world. First of all,
chosen coordinate system. extending to Cartesian 
\begin{gather}
