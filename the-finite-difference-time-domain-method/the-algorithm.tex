...
\begin{gather}
  \begin{array}{@{}l@{}}
    ...
    \displaystyle c_0\left(\frac{H_x|_{i,j+\frac{1}{2},k+\frac{1}{2}}^{n} - H_x|_{i,j+\frac{1}{2},k-\frac{1}{2}}^{n}}{\Delta z} - \frac{H_y|_{i+\frac{1}{2},j+\frac{1}{2},k}^{n} - H_y|_{i-\frac{1}{2},j+\frac{1}{2},k}^{n}}{\Delta x}\right)\\[3em]
    ...
    \displaystyle \frac{\widetilde{B}_x|_{i,j+\frac{1}{2},k+\frac{1}{2}}^{n+\frac{1}{2}} - \widetilde{B}_x|_{i,j+\frac{1}{2},k+\frac{1}{2}}^{n-\frac{1}{2}}}{\Delta t} = \\
    \displaystyle c_0\left(\frac{\widetilde{E}_z|_{i,j+1,k+\frac{1}{2}}^{n} - \widetilde{E}_z|_{i,j,k+\frac{1}{2}}^{n}}{\Delta y} - \frac{\widetilde{E}_y|_{i,j+\frac{1}{2},k+1}^n - \widetilde{E}_y|_{i,j+\frac{1}{2},k}^n}{\Delta z}\right)\\[3em]
    \displaystyle \frac{\widetilde{B}_y|_{i,j+\frac{1}{2},k+\frac{1}{2}}^{n+\frac{1}{2}} - \widetilde{B}_y|_{i,j+\frac{1}{2},k+\frac{1}{2}}^{n-\frac{1}{2}}}{\Delta t} = \\
    \displaystyle c_0\left(\frac{\widetilde{E}_x|_{i,j+1,k+\frac{1}{2}}^{n} - \widetilde{E}_x|_{i,j,k+\frac{1}{2}}^{n}}{\Delta z} - \frac{\widetilde{E}_z|_{i,j+\frac{1}{2},k+1}^n - \widetilde{E}_z|_{i,j+\frac{1}{2},k}^n}{\Delta x}\right)\\[3em]
    \displaystyle \frac{\widetilde{B}_z|_{i,j+\frac{1}{2},k+\frac{1}{2}}^{n+\frac{1}{2}} - \widetilde{B}_z|_{i,j+\frac{1}{2},k+\frac{1}{2}}^{n-\frac{1}{2}}}{\Delta t} = \\
    \displaystyle c_0\left(\frac{\widetilde{E}_y|_{i,j+1,k+\frac{1}{2}}^{n} - \widetilde{E}_y|_{i,j,k+\frac{1}{2}}^{n}}{\Delta x} - \frac{\widetilde{E}_x|_{i,j+\frac{1}{2},k+1}^n - \widetilde{E}_x|_{i,j+\frac{1}{2},k}^n}{\Delta y}\right)
  \end{array}
\end{gather}
...
\begin{code}
  D_x[i,j,k] = D_x[i,j,k] 
  + 0.5 * ( H_z[i,j,k] - H_z[i,j-1,k] - H_y[i,j,k] + H_y[i,j,k-1] )
\end{code}
...
\begin{gather}
  ...
  \frac{\widetilde{B}_y|_{k+\frac{1}{2}}^{n+1} - \widetilde{B}_y|_{k+\frac{1}{2}}^n}{\Delta t} = -c_0\cdot\frac{E_x|_{k+1}^{n+\frac{1}{2}} - E_x|_{k}^{n+\frac{1}{2}}}{\Delta z}
\end{gather}
That is
\begin{gather}
  ...
  \widetilde{B}_y|_{k+\frac{1}{2}}^{n+1} = \widetilde{B}_y|_{k+\frac{1}{2}}^{n} = - \frac{c_0\Delta t}{\Delta z}\left( E_x|_{k+1}^{n+\frac{1}{2}} - E_x|_{k}^{n+\frac{1}{2}} \right)
\end{gather}
Here is the code
\begin{code}
