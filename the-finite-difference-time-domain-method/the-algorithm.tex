...
Following is the most well-known form of Maxwell's Equations\index{Maxwell's Equations}, for getting sysmetrical form
and handling metamaterial, novel magnetic current $M$ was added into Faraday's Law.
\begin{gather}
  \label{eq:maxwell}
  \begin{array}{@{}rclr@{}}
...
\sigma_h H$.
\begin{gather}
  \epsilon\frac{\partial E}{\partial t} + \sigma_eE = \nabla \times H\\
  \mu\frac{\partial H}{\partial t} + \sigma_hH = - \nabla \times E
\end{gather}
gather coefficient 
\begin{gather}
  \frac{\partial E}{\partial t} + \frac{\sigma_e}{\epsilon_r\epsilon_0}E = \frac{1}{\epsilon_r\epsilon_0}\nabla\times H\\
  \frac{\partial H}{\partial t} + \frac{\sigma_h}{\mu_r\mu_0}H = - \frac{1}{\mu_r\mu_0}\nabla\times E
\end{gather}
